...
(function () {
    ...
    function initElements() {
        ...
        elements.metricTypeSelect = document.getElementById('metricTypeSelect');
    ...
    function initEventListeners() {
        ...
        // Metric type change
        if (elements.metricTypeSelect) {
            elements.metricTypeSelect.addEventListener('change', function () {
                selectedMetricType = this.value;
            });
        } else {
            console.error('Analytics: Metric type select not found');
        }
    ...
    function resetFilters() {
        ...
        // Reset metric type to Report Count
        if (elements.metricTypeSelect) {
